...
class TestFlaskApiClient:
    ...
    def test_add_content(self):
        ...
        (assert_that(response_data.status_code, "Desired data was not posted to web application successfully")
         .is_equal_to(200))

        (assert_that(response_data.json().get("message"), "Message from api is not equal to expected.")
         .is_equal_to("Content created successfully!"))
